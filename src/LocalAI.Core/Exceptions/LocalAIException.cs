namespace LocalAI.Exceptions;

/// <summary>
/// Base exception for all LocalAI errors.
/// </summary>
public class LocalAIException : Exception
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LocalAIException"/> class.
    /// </summary>
    public LocalAIException()
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="LocalAIException"/> class with a specified error message.
    /// </summary>
    ...
    public LocalAIException(string message, Exception innerException) : base(message, innerException)
    {
    }
}
...
/// </summary>
public class TokenizationException : LocalAIException
{
    /// <summary>
